...
def reset_level(level):
    ...
    lava_group.empty()
    exit_group.empty()
    if path.exists(f'/Users/alexanderdiaz/Desktop/Platformer-Game/level{level}_data'):
        pickle_in = open(f'/Users/alexanderdiaz/Desktop/Platformer-Game/level{level}_data', 'rb')
...
class World():
    def __init__(self, data):
        self.tile_list = []
        # load images
        dirt_img = pygame.image.load('/Users/alexanderdiaz/Desktop/Platformer-Game/dirt.png')
        grass_img = pygame.image.load('/Users/alexanderdiaz/Desktop/Platformer-Game/grass.png')
        row_count = 0
        for row in data:
            col_count = 0
            for tile in row:
...
class Coin(pygame.sprite.Sprite):
    def __init__(self, x, y):
        pygame.sprite.Sprite.__init__(self)  # calling from super class
        img = pygame.image.load('/Users/alexanderdiaz/Desktop/Platformer-Game/coin.png')
...
class Exit(pygame.sprite.Sprite):
    def __init__(self, x, y):
        pygame.sprite.Sprite.__init__(self)  # calling from super class
        img = pygame.image.load('/Users/alexanderdiaz/Desktop/Platformer-Game/exit.png')
    ...
    if main_menu == True:
        ...
        if game_over == -1:
            if restart_button.draw():
                ...
                game_over = 0
                score = 0
        # if player has complete the level
        if game_over == 1:
